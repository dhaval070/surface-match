...
export default function Layout() {
    ...
    <div className="flex" >
        <div className="text-left grow">
            ...
            <button className="rounded text-left ml-10 bg-slate-400 py-2 px-4 text-sm  data-[hover]:bg-slate-500 data-[active]:bg-sky-700" onClick={() => navigate("/sites-config")}>Sites Config</button>
        </div>
