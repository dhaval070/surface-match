...
export default function Users() {
    ...
    }, [api, setBusy, setUsers, showMessage])
    ...
    const handleDeleteUser = () => {
        setBusy(true)
        api.delete(`${apiurl}/users/${selectedUsername}`).then(() => {
    ...
    return (
        <div className="App w-full">
            ...
            {apiMessage && (
                <div className={`fixed top-4 right-4 px-6 py-3 rounded-lg shadow-lg z-50 ${messageType === 'success' ? 'bg-green-500' : 'bg-red-500'
                    } text-white`}>
                    {apiMessage}
                </div>
            )}
